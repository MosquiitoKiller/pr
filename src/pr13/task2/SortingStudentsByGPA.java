...
public class SortingStudentsByGPA{
    ...
    public SortingStudentsByGPA(int n) {
        testClass=new TestClass(n);
    }
    void sortGpaMerge(){
        this.testClass.students= sortMerge(this.testClass.students);
    }

    void sortGpaQuick(){
        quickSort(this.testClass.students,0,this.testClass.students.length-1);
    }
